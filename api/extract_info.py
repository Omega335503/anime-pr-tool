...
- "SNS" … YouTube・Instagram・TikTok等のX以外のSNSでの投稿・更新。「YouTube更新」「Instagram投稿」「TikTok」等はこれ
...
- 「YouTube更新」「Instagram投稿」「TikTok」→ 必ず "SNS"
- 「ミーティング」「MTG」→ 必ず "MTG"
- 「PV公開」「KV公開」→ "制作物"
- 「プレスリリース」「PR」→ "プレスリリース"
- 迷ったら内容で判断し、SNSプラットフォームでの更新は全て "SNS"
...
- 例: 9/4に「プレスリリース」と「YouTube更新」と「X更新」がある場合 → 3つのエントリに分割
  ...
  - {date:"9/4", category:"SNS", title:"YouTube更新", items:[...]}
  - {date:"9/4", category:"SNS", title:"X更新", items:[...]}
